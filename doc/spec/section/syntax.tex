...
\begin{align*}
    \begin{array}{rcll}
        ...
        &\mathrel{/} &\mathit{local\_decl} \\
        \mathit{bind\_expr}
        &\Coloneq &\mathit{declvar}\; \mathit{type}{?}\; \mathrm{\#eq}(\mathit{expr}) \\
        \mathit{bind\_type}
        &\Coloneq &\mathit{declvar}\; \mathit{type}{?}\; \mathrm{\#eq}(\mathit{type}) \\
        \mathit{bind\_prom\_type}
        &\Coloneq &\mathrm{\#prom}(\mathit{declvar}\; \mathit{type}{?}\; \mathrm{\#eq}(\mathit{type}))
    \end{array}
\end{align*}
...
\begin{align*}
    \begin{array}{rcll}
        ...
        \mathit{type\_tuple\_sig\_item}
        &\Coloneq &\mathrm{\#prom}(\mathit{var}; \mathit{type}) \\
