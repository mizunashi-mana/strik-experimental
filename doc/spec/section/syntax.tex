...
\begin{align*}
    \begin{array}{rcll}
        ...
        &\mathrel{/} &\mathit{decl\_type} \\
        \mathit{decl\_func}
        &\Coloneq &\texttt{"\#fun"}\; \mathit{declvar}\; \mathit{type\_tuple\_sig}\; (\texttt{":"}\; \mathit{type}){?}\; \texttt{"="}\; \mathit{expr} \\
        \mathit{decl\_type}
        &\Coloneq &\texttt{"\#type"}\; \mathit{declvar}\; (\texttt{":"}\; \mathit{type}){?}\; \texttt{"="}\; \mathit{type} \\
    \end{array}
\end{align*}
...
\begin{align*}
    \begin{array}{rcll}
        ...
        \mathit{decl\_type}
        &\Coloneq &\mathrm{\#type}(\mathit{declvar}; \mathit{decl\_sig}; \mathit{type}) \\
        \mathit{decl\_sig}
