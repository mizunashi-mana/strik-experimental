...
\begin{align*}
    \begin{array}{rcll}
        \mathit{program}
        &\Coloneq &\mathit{expr}\; \mathbf{EOS}
    \end{array}
\end{align*}
...
\begin{align*}
    \begin{array}{rcll}
        ...
        &\mathrel{/} &\mathit{local\_decl} \\
        \mathit{bind\_expr}
        &\Coloneq &\mathrm{\#bind\_expr}(\mathit{declvar}; \mathit{bind\_sig}; \mathit{expr}) \\
        \mathit{bind\_type}
        &\Coloneq &\mathrm{\#bind\_type}(\mathit{declvar}; \mathit{bind\_sig}; \mathit{type}) \\
        \mathit{bind\_prom\_type}
        &\Coloneq &\mathrm{\#bind\_prom}(\mathit{declvar}; \mathit{bind\_sig}; \mathit{type}) \\
        \mathit{bind\_sig}
        &\Coloneq &\mathrm{\#bind\_sig}(\mathit{type}) \\
        &\mathrel{/} &\mathrm{\#bind\_sig\_nothing}
    \end{array}
\end{align*}
