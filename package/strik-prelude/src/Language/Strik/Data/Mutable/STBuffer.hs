module Language.Strik.Data.Mutable.STBuffer (
    T,
    STBuffer (..),
    new,
    length,
...
import           Language.Strik.Prelude              hiding (index, last,
                                                      length, unsafeHead,
                                                      unsafeIndex, unsafeLast)

import qualified GHC.ST                              as ST
import qualified Language.Strik.Data.Unlifted.MutInt as MutInt
