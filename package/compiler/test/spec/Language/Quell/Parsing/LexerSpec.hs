        ...
        it "returns tokens without any reports" do
            ...
            ts `shouldBe`
                [
                    ...
                    Spanned {getSpan = Span {beginLoc = Loc {locBytesPos = 1, locLine = 0, locCol = 1}, endLoc = Loc {locBytesPos = 3, locLine = 0, locCol = 3}}, unSpanned = IdVarId do textId "id"},
                    Spanned {getSpan = Span {beginLoc = Loc {locBytesPos = 4, locLine = 1, locCol = 0}, endLoc = Loc {locBytesPos = 5, locLine = 1, locCol = 1}}, unSpanned = IdVarId do textId "x"},
                    ...
                    Spanned {getSpan = Span {beginLoc = Loc {locBytesPos = 6, locLine = 1, locCol = 2}, endLoc = Loc {locBytesPos = 9, locLine = 1, locCol = 5}}, unSpanned = LitInteger 0},
                    ...
                    Spanned {getSpan = Span {beginLoc = Loc {locBytesPos = 10, locLine = 1, locCol = 6}, endLoc = Loc {locBytesPos = 14, locLine = 1, locCol = 10}}, unSpanned = IdVarId do textId "aa00"},
                    ...
                    Spanned {getSpan = Span {beginLoc = Loc {locBytesPos = 15, locLine = 1, locCol = 11}, endLoc = Loc {locBytesPos = 18, locLine = 1, locCol = 14}}, unSpanned = LitInteger 101},
                    Spanned {getSpan = Span {beginLoc = Loc {locBytesPos = 19, locLine = 1, locCol = 15}, endLoc = Loc {locBytesPos = 23, locLine = 1, locCol = 19}}, unSpanned = LitInteger 103},
                    Spanned {getSpan = Span {beginLoc = Loc {locBytesPos = 23, locLine = 1, locCol = 19}, endLoc = Loc {locBytesPos = 28, locLine = 1, locCol = 24}}, unSpanned = LitRational do (-40) % 1},
                    Spanned {getSpan = Span {beginLoc = Loc {locBytesPos = 28, locLine = 1, locCol = 24}, endLoc = Loc {locBytesPos = 30, locLine = 1, locCol = 26}}, unSpanned = IdVarId do textId "a0"},
                    ...
                    Spanned {getSpan = Span {beginLoc = Loc {locBytesPos = 31, locLine = 1, locCol = 27}, endLoc = Loc {locBytesPos = 36, locLine = 1, locCol = 32}}, unSpanned = LitRational do 400000000000 % 1},
                    Spanned {getSpan = Span {beginLoc = Loc {locBytesPos = 36, locLine = 1, locCol = 32}, endLoc = Loc {locBytesPos = 38, locLine = 1, locCol = 34}}, unSpanned = IdVarId do textId "o0"},
                    ...
                    Spanned {getSpan = Span {beginLoc = Loc {locBytesPos = 40, locLine = 1, locCol = 36}, endLoc = Loc {locBytesPos = 49, locLine = 1, locCol = 45}}, unSpanned = LitByteString do byteString "a\NUL"},
                    Spanned {getSpan = Span {beginLoc = Loc {locBytesPos = 50, locLine = 1, locCol = 46}, endLoc = Loc {locBytesPos = 58, locLine = 1, locCol = 54}}, unSpanned = LitChar '\DC1'},
