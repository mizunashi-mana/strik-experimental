...
import Language.Quell.Parsing.Spanned (Spanned (..), Span)
import qualified Language.Parser.Ptera.TH                as Ptera
import qualified Language.Haskell.TH as TH
import Language.Quell.Parsing.Parser.AstParsedTag (AstParsedTag, tokenSpan, (<>>))
import           Language.Parser.Ptera.TH                (pattern (:*),
                                                          pattern HNil,
                                                          ruleExpr, varA, tokA, eps,
                                                          (<:>), (<^>))
import Language.Quell.Parsing.Parser.LiftTypes ()
import Language.Quell.Frontend.Data.ParsedAst (extractX)
